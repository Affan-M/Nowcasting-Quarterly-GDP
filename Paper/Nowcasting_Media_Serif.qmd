...
include-in-header: 
  - text: |
      ...
      \usepackage{fontspec}
      \usepackage{setspace}
      \definecolor{col}{HTML}{262626}
      \color{col}
      \pagestyle{empty}
      \onehalfspacing
      \captionsetup[table]{labelfont=bf, font=bf}
      \captionsetup[figure]{labelfont=bf, font=bf}
      \newfontfamily\hfont{Cambria}
      \addtokomafont{title}{\hfont\fontsize{17}{25.5}\selectfont\bfseries}
      \addtokomafont{section}{\hfont\fontsize{16}{24}\selectfont\mdseries}
      \addtokomafont{subsection}{\hfont\fontsize{16}{24}\selectfont\mdseries}
      \addtokomafont{subsubsection}{\hfont\fontsize{16}{24}\selectfont\mdseries}
      \newcommand{\subsubsubsection}[1]{\paragraph{#1}\mbox{}\\}
      \setkomafont{paragraph}{\hfont\fontsize{16}{24}\selectfont\mdseries}
      \renewcommand{\cfttoctitlefont}{\hfont\fontsize{16}{24}\selectfont}
...
![Quarterly National Accounts](Flow%20charts/Mermaid_files/figure-commonmark/mermaid-figure-1.png){#fig-qna width="65%"}
